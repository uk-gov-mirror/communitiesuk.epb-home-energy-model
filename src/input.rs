...
use serde_valid::validation::{ArrayErrors, Error, ObjectErrors, PropertyErrorsMap, VecErrors};
...
{
    Single(#[validate] T),
    Map(#[validate] IndexMap<ArcStr, T>),
}
...
pub struct MechanicalVentilationJsonValue<'a>(pub &'a mut Map<ArcStr, JsonValue>);
